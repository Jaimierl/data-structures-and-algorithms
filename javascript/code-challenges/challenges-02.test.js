...
const raisedToTheThird = (arr) => {
  let arr1 = [];
  arr.forEach(elem => {
    arr1.push(Math.pow(elem, 3));
  });
  return arr1;
};

// const raisedToTheThird = arr.forEach((element) => {
...
const mapTwoToThe = (arr) => {
  let arr6 = arr.map((elem) => {
    return elem = (Math.pow(2, elem));
  });
  return arr6;
};
...
const charCode = (arr) => {
  let arr7 = arr.map((elem) => {
    return elem = (elem.charCodeAt());
  });
  return arr7;
};
...
const extractAbilities = (arr) => {
  let arr9 = arr.map((elem) => {
    return elem = (elem.ability.name);
  });
  return arr9;
};
